...
app = FastAPI(
    title="Node Games API",
    description="A comprehensive API for a gaming platform",
    version="1.0.0",
...
<html lang="en">
  <head>
    ...
    <title>Node Games API DOCS</title>
...
def home():
    """This is the first and default route for the Node Games Backend"""
    return """
    <html>
      <head>
        <title>Node Games API</title>
        <style>
      ...
      <body>
        <h1>Welcome to Node Games API</h1>
        <hr>
        <ul>
